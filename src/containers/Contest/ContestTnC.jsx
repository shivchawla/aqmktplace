    ...
    renderPageContent() {
        return (
            <div style={{padding: '20px 40px', fontSize: '16px'}}>
                ...
                <p><strong>Net Value: </strong><span >Total Net Value of contest entries must be at-least Rs. 4.5 Lacs and should be less than Rs.5 Lacs. &nbsp;Due to market conditions, the Net Value may go beyond the limits to a low of Rs. 4 Lacs or upto Rs 5.5 Lacs on the high side. In case these limits are hit, Net Value must be adjusted back to the originals limits of Rs. 4.5 Lacs and Rs. 5 Lacs</span></p>
                ...
                <p><strong>Low position concentration</strong><span >: Contest entries cannot have more than Rs. 50,000 invested in any one asset. This is checked at the end of each trading day. &nbsp;Due to market movement, your investment portfolio may exceed this limit to a hard limit of Rs. 60,000. In case the limit exceed the hard limit of Rs. 60,000, position must be adjusted immediately back to under Rs. 50,000.</span></p>
                ...
                <p><strong>Low sector concentration</strong><span >: Contest entries with diversified benchmark (NIFTY_50, NIFTY_MIDCAP_50 or NIFTY_DIV_OPPS_50) cannot have more than Rs. 1.5 Lacs of their capital invested in any one sector. This is checked at the end of each trading day. &nbsp;Due to market movement, your investment portfolio may exceed this limit to a hard limit of Rs. 1.8 Lacs. In case the limit exceed the hard limit, position must be adjusted immediately back to under Rs. 1.5 Lacs.</span></p>
                ...
                <p style={bulletStyle}><span >5. Each Participant may submit up to 3 entries to the contest.</span></p>
                ...
                <p>&nbsp;</p>
                <p><span >Last revised: 7th August 2018</span></p>
                <p><br /><br /><br /></p>
            </div>
        );
    }
