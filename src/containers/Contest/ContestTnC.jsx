    ...
    renderPageContent() {
        return (
            <div style={{padding: '20px 40px', fontSize: '16px'}}>
                ...
                <p><strong>Net Value: </strong><span >Total Net Value of contest entries must be at-least Rs. 4.5 Lacs. &nbsp;Due to market conditions, the Net Value may go beyond the limits to a low of Rs. 4 Lacs. In case these limits are hit, Net Value must be adjusted back to the originals limit of Rs. 4.5 Lacs</span></p>
