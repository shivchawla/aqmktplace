    ...
    renderPageContent() {
        return (
            <div style={{padding: '20px 40px', fontSize: '16px'}}>
                ...
                <p><strong>Low sector concentration</strong><span >: Contest entries with diversified benchmark (NIFTY_50, NIFTY_MIDCAP_50 or NIFTY_DIV_OPPS_50) cannot have more than Rs. 1.8 Lacs of their capital invested in any one sector. This is checked at the end of each trading day. &nbsp;Due to market movement, your investment portfolio may exceed this limit to a hard limit of Rs. 2.1 Lacs. In case the limit exceed the hard limit, position must be adjusted immediately back to under Rs. 1.8 Lacs.</span></p>
